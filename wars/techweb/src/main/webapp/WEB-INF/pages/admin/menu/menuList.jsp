...
<youi:page caption="菜单管理">
    ...
    <youi:xmenu id="xmenu_menu">
        ...
        <youi:xmenuItem caption="删除菜单-{0}" icon="remove" name="removeMenu" groups="source-data"/>
    </youi:xmenu>
    ...
    <youi:customWidget name="page_spliter" widgetName="pageSpliter" styleClass="col-sm-3 page-inner-height">
        <youi:toolbar refWidgetId="tree_menu" styleClass="fixed-height">
            <youi:toolbarItem caption="添加" tooltips="新增菜单" name="xmenu_addMenu" icon="plus"/>
            <youi:toolbarItem caption="全展开" tooltips="展开菜单" name="expandAll" icon="expand-alt"/>
        </youi:toolbar>
    ...
    <div class="col-sm-9 page-inner-height page-spliter-right">
        <youi:toolbar refWidgetId="form_menu">
            ...
            <youi:toolbarItem caption="清除角色关联" tooltips="清除角色关联" name="removeRefRoles" icon="remove" groups="menu"/>
