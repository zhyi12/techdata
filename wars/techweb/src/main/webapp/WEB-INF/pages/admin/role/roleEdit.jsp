...
<youi:page caption="角色编辑" autoLoadData="${param.roleId!=null}" dataSrc="/operatorServices/services/roleManager/getRole.json?roleId=${param.roleId}">
	<youi:form id="form_role" panel="false" submit="NOT" reset="NOT" action="/operatorServices/services/roleManager/saveRole.json"
		idKeys="roleId">
