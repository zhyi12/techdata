...
<youi:page caption="角色授权" dataSrc="/operatorServices/services/roleManager/getRoleMenus.json?roleId=${param.roleId}">
	...
	<youi:form id="form_role_auth" panel="false" idKeys="roleId"  submit="NOT" reset="NOT"
		...
		action="/operatorServices/services/roleManager/saveRoleMenus.json">
